        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/showcase/112010962/admin?lipi=urn%3Ali%3Apage%3Ad_flagship3_showcase_admin%3BZ2hzPJtfQ3aOImnr08bIxg%3D%3D" className="text-[#d4d4c4] hover:text-[#8b1a1a] transition-colors">
